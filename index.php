    ...
    <div class="container">
        ...
        <p>
           <form accept-charset="utf-8" method="POST">
            ...
            <input type="text" name="patient_filter" id='patient_filter' onkeyup="buscar();" />
        ...
        <div class="row">
            ...
            <div class="col-xs-4 hidden-sm hidden-xs">Age</div>
        ...
        <?php foreach($patients as $patient): ?>
            <div class="row">
                ...
                <div class="col-xs-4 hidden-sm hidden-xs"> <?php echo $patient->patient_age; ?></div>
